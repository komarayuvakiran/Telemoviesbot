...
# Example usage of the port checking function ```python
...
# Example usage of the port checking function
host = '127.0.0.1'  # Replace with your server's IP address
port = 8080  # Replace with the port you want to check if check_port_open(host, port):
    print(f"Port {port} is open on {host}.")
else:
    print(f"Port {port} is closed on {host}.")
